...
- `README.md` 是給一般人看的，尤其是非工程背景的 Chris。保持簡短、白話、少放程式碼與 API 細節。
- `AGENTS.md` 是給 Jay、Codex、AI agent 或工程協作者看的。技術決策、安全規則、local 測試方式、不要踩的坑都寫在這裡。
- 如果要新增複雜技術說明，優先放在 `AGENTS.md`，不要把 README 變成工程文件。
